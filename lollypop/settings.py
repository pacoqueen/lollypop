...
class Settings(Gio.Settings):
    ...
    @staticmethod
    def new():  # pylint: disable=arguments-differ
        """
...
#######################
    ...
    def __on_pa_list_sinks(self, source, result, combo):
        ...
        except Exception as pulseaudioexception:
            outputs = []
        if outputs:
    ...
    def __on_can_set_cover(self, source, result, data):
        ...
        # pylint: disable=broad-except,unused-variable
        except Exception as coverexception:
            can_set_cover = False
        ...
        if not can_set_cover:
            ...
            latt = grid.child_get_property(switch_artwork_tags, "left-attach")
